...
// generic ISO set used as a base.
// ISO does some weird stuff, the keys are not necessarily just where they look like on the board. 
// Eg it has to go `EQS, DEL, BSPC`, and `LBRC, RBRC, BSLS`. Whatever, it works.
...
// put menu key up top right, next to F12. Have never used printsc or scroll lock so whatever.
	...
	[0] = LAYOUT(
    KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_APP,   KC_PAUSE, KC_HOME,
    ...
    KC_LCTL,  KC_LGUI,  KC_LALT,                      KC_SPC,   KC_SPC,   KC_SPC,                       KC_LALT,  MO(1),    KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT
  ),
...
// func + menu mapped to escape so I can cancel opening it with the same keys instead of moving across the board.
	[1] = LAYOUT(
    RESET,    _______,  _______,  _______, _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_ESC,   _______,  _______,
